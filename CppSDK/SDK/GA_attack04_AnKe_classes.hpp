...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_attack04_AnKe_C;                 // 0x0558(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(UGA_attack04_AnKe_C) == 0x000560, "Wrong size on UGA_attack04_AnKe_C");
static_assert(offsetof(UGA_attack04_AnKe_C, UberGraphFrame_GA_attack04_AnKe_C) == 0x000558, "Member 'UGA_attack04_AnKe_C::UberGraphFrame_GA_attack04_AnKe_C' has a wrong offset!");
