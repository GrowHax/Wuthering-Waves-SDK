...
{
public:
	struct FPointerToUberGraphFrame               UberGraphFrame_GA_Anke_Rage2_C;                    // 0x0558(0x0008)(ZeroConstructor, Transient, DuplicateTransient)
...
static_assert(sizeof(UGA_Anke_Rage2_C) == 0x000560, "Wrong size on UGA_Anke_Rage2_C");
static_assert(offsetof(UGA_Anke_Rage2_C, UberGraphFrame_GA_Anke_Rage2_C) == 0x000558, "Member 'UGA_Anke_Rage2_C::UberGraphFrame_GA_Anke_Rage2_C' has a wrong offset!");
