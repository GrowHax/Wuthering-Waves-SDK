...
void UGA_Comboo_Vision_C::角色受击(class ATsBaseCharacter_C* 角色, const struct FSHitInformation& 受击数据)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("GA_Comboo_Vision_C", "角色受击");

	Params::GA_Comboo_Vision_C_角色受击 Parms{};
