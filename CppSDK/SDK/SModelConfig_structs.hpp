...
public:
	...
	TSoftClassPtr<class UClass>                   蓝图_164_769F290B4EFC164B65A1599B535666B6;         // 0x0008(0x0030)(Edit, BlueprintVisible, HasGetValueTypeHash)
	TSoftObjectPtr<class USkeletalMesh>           网格体_168_BEB7464046E518BA05D4C799C3CC4633;       // 0x0038(0x0030)(Edit, BlueprintVisible, HasGetValueTypeHash)
	TArray<TSoftObjectPtr<class USkeletalMesh>>   子网格体_196_D82578F34F1E4A691036E99B5FB78226;     // 0x0068(0x0010)(Edit, BlueprintVisible)
	...
	TMap<struct FGameplayTag, struct FSoftObjectPath> 常驻特效列表_130_465C46E24D4666BB95A752AF0B533A8B; // 0x0198(0x0050)(Edit, BlueprintVisible)
	TMap<struct FGameplayTag, struct FSoftObjectPath> 变化特效列表_131_0C1F295C46E6663CA7B5A6B7B1D7D4F9; // 0x01E8(0x0050)(Edit, BlueprintVisible)
	TMap<struct FGameplayTag, struct FSNiagaraParam> 通用特效常驻参数_113_79874DD14ED056D882E1019173BE819F; // 0x0238(0x0050)(Edit, BlueprintVisible)
	TMap<struct FGameplayTag, struct FSNiagaraParam> 通用特效变化参数_114_35E165954D765F21271E5F8EFB23007D; // 0x0288(0x0050)(Edit, BlueprintVisible)
	struct FSoftObjectPath                        场景交互物_142_56A2D5ED420A09047B55538B0A789828;   // 0x02D8(0x0020)(Edit, BlueprintVisible, ZeroConstructor, HasGetValueTypeHash)
	TMap<struct FGameplayTag, EKuroSceneInteractionState> 场景交互物状态列表_144_70E5A0E44592B5CC8C81789E5CBAF975; // 0x02F8(0x0050)(Edit, BlueprintVisible)
	TMap<struct FGameplayTag, ESceneInteractionEffect> 场景交互物特效列表_160_269D1C9D465A43640E572894290F2EA9; // 0x0348(0x0050)(Edit, BlueprintVisible)
	...
	int32                                         名字Z偏移_188_E8CB9C9A43F04B2BF247FD9E233CBE80;    // 0x03A0(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	float                                         注释时的抬升角度_192_4AFA30A74F0864E1CEE43B930EDB3B36; // 0x03A4(0x0004)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	EBodyType                                     体型类型_199_997203F4416F68DB877D96A595F2AC51;     // 0x03A8(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
	bool                                          主角蓝透_201_B2B40294482FF0B8641BE98CCAA2E7BC;     // 0x03A9(0x0001)(Edit, BlueprintVisible, ZeroConstructor, IsPlainOldData, NoDestructor)
