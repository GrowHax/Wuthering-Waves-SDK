...
public:
	...
	TDelegate<void(const struct FGameplayTag& Tag)> K2Node_CreateDelegate_OutputDelegate;            // 0x0048(0x0028)(ZeroConstructor)
	...
	TDelegate<void(const struct FGameplayTag& Tag)> K2Node_CreateDelegate_OutputDelegate_1;          // 0x0098(0x0028)(ZeroConstructor)
	...
	TDelegate<void(const struct FGameplayTag& Tag)> K2Node_CreateDelegate_OutputDelegate_2;          // 0x00F8(0x0028)(ZeroConstructor)
...
static_assert(sizeof(GA_Common_AirShot_C_ExecuteUbergraph_GA_Common_AirShot) == 0x000180, "Wrong size on GA_Common_AirShot_C_ExecuteUbergraph_GA_Common_AirShot");
...
static_assert(offsetof(GA_Common_AirShot_C_ExecuteUbergraph_GA_Common_AirShot, CallFunc_MakeVectorDouble_ReturnValue) == 0x000158, "Member 'GA_Common_AirShot_C_ExecuteUbergraph_GA_Common_AirShot::CallFunc_MakeVectorDouble_ReturnValue' has a wrong offset!");
static_assert(offsetof(GA_Common_AirShot_C_ExecuteUbergraph_GA_Common_AirShot, CallFunc_Conv_IntToString_ReturnValue_1) == 0x000170, "Member 'GA_Common_AirShot_C_ExecuteUbergraph_GA_Common_AirShot::CallFunc_Conv_IntToString_ReturnValue_1' has a wrong offset!");
