...
public:
	...
	uint8                                         Pad_128[0x118];                                    // 0x0128(0x0118)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UMovieSceneCapture) == 0x000240, "Wrong size on UMovieSceneCapture");
...
{
public:
	bool                                          bAutoStartCapture;                                 // 0x0240(0x0001)(Edit, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_241[0xB];                                      // 0x0241(0x000B)(Fixing Size After Last Property [ Dumper-7 ])
	struct FGuid                                  PrerequisiteActorId;                               // 0x024C(0x0010)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPrivate)
...
static_assert(offsetof(ULevelCapture, bAutoStartCapture) == 0x000240, "Member 'ULevelCapture::bAutoStartCapture' has a wrong offset!");
static_assert(offsetof(ULevelCapture, PrerequisiteActorId) == 0x00024C, "Member 'ULevelCapture::PrerequisiteActorId' has a wrong offset!");
