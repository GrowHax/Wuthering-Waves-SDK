...
static_assert(sizeof(UBehaviorTreeComponent) == 0x000300, "Wrong size on UBehaviorTreeComponent");
...
static_assert(sizeof(UAISense) == 0x000090, "Wrong size on UAISense");
static_assert(offsetof(UAISense, DefaultExpirationAge) == 0x000030, "Member 'UAISense::DefaultExpirationAge' has a wrong offset!");
static_assert(offsetof(UAISense, NotifyType) == 0x000034, "Member 'UAISense::NotifyType' has a wrong offset!");
static_assert(offsetof(UAISense, PerceptionSystemInstance) == 0x000040, "Member 'UAISense::PerceptionSystemInstance' has a wrong offset!");
...
static_assert(sizeof(UAISense_Prediction) == 0x0000A0, "Wrong size on UAISense_Prediction");
static_assert(offsetof(UAISense_Prediction, RegisteredEvents) == 0x000090, "Member 'UAISense_Prediction::RegisteredEvents' has a wrong offset!");
...
public:
	...
	TMulticastInlineDelegate<void(const struct FAIRequestID& RequestID, EPathFollowingResult Result)> ReceiveMoveCompleted; // 0x03A8(0x0010)(ZeroConstructor, InstancedReference, BlueprintAssignable, NativeAccessSpecifierPublic)
...
static_assert(sizeof(UBTCompositeNode) == 0x000098, "Wrong size on UBTCompositeNode");
...
static_assert(sizeof(UAISense_Damage) == 0x0000A0, "Wrong size on UAISense_Damage");
static_assert(offsetof(UAISense_Damage, RegisteredEvents) == 0x000090, "Member 'UAISense_Damage::RegisteredEvents' has a wrong offset!");
...
public:
	...
	uint8                                         Pad_A4[0xAC];                                      // 0x00A4(0x00AC)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UAIPerceptionSystem) == 0x000150, "Wrong size on UAIPerceptionSystem");
...
static_assert(offsetof(UAIPerceptionComponent, SensesConfig) == 0x0000C0, "Member 'UAIPerceptionComponent::SensesConfig' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, DominantSense) == 0x0000D0, "Member 'UAIPerceptionComponent::DominantSense' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, AIOwner) == 0x0000E8, "Member 'UAIPerceptionComponent::AIOwner' has a wrong offset!");
static_assert(offsetof(UAIPerceptionComponent, OnPerceptionUpdated) == 0x000170, "Member 'UAIPerceptionComponent::OnPerceptionUpdated' has a wrong offset!");
...
static_assert(sizeof(UAISense_Blueprint) == 0x0000B8, "Wrong size on UAISense_Blueprint");
static_assert(offsetof(UAISense_Blueprint, ListenerDataType) == 0x000090, "Member 'UAISense_Blueprint::ListenerDataType' has a wrong offset!");
...
static_assert(sizeof(UAISense_Sight) == 0x000180, "Wrong size on UAISense_Sight");
static_assert(offsetof(UAISense_Sight, MaxTracesPerTick) == 0x000158, "Member 'UAISense_Sight::MaxTracesPerTick' has a wrong offset!");
static_assert(offsetof(UAISense_Sight, MinQueriesPerTimeSliceCheck) == 0x00015C, "Member 'UAISense_Sight::MinQueriesPerTimeSliceCheck' has a wrong offset!");
...
static_assert(sizeof(UAISense_Team) == 0x0000A0, "Wrong size on UAISense_Team");
static_assert(offsetof(UAISense_Team, RegisteredEvents) == 0x000090, "Member 'UAISense_Team::RegisteredEvents' has a wrong offset!");
...
static_assert(sizeof(UAISystem) == 0x000158, "Wrong size on UAISystem");
static_assert(offsetof(UAISystem, PerceptionSystemClassName) == 0x000070, "Member 'UAISystem::PerceptionSystemClassName' has a wrong offset!");
static_assert(offsetof(UAISystem, HotSpotManagerClassName) == 0x000090, "Member 'UAISystem::HotSpotManagerClassName' has a wrong offset!");
static_assert(offsetof(UAISystem, AcceptanceRadius) == 0x0000B0, "Member 'UAISystem::AcceptanceRadius' has a wrong offset!");
static_assert(offsetof(UAISystem, PathfollowingRegularPathPointAcceptanceRadius) == 0x0000B4, "Member 'UAISystem::PathfollowingRegularPathPointAcceptanceRadius' has a wrong offset!");
static_assert(offsetof(UAISystem, PathfollowingNavLinkAcceptanceRadius) == 0x0000B8, "Member 'UAISystem::PathfollowingNavLinkAcceptanceRadius' has a wrong offset!");
static_assert(offsetof(UAISystem, bFinishMoveOnGoalOverlap) == 0x0000BC, "Member 'UAISystem::bFinishMoveOnGoalOverlap' has a wrong offset!");
static_assert(offsetof(UAISystem, bAcceptPartialPaths) == 0x0000BD, "Member 'UAISystem::bAcceptPartialPaths' has a wrong offset!");
static_assert(offsetof(UAISystem, bAllowStrafing) == 0x0000BE, "Member 'UAISystem::bAllowStrafing' has a wrong offset!");
static_assert(offsetof(UAISystem, bEnableBTAITasks) == 0x0000BF, "Member 'UAISystem::bEnableBTAITasks' has a wrong offset!");
static_assert(offsetof(UAISystem, bAllowControllersAsEQSQuerier) == 0x0000C0, "Member 'UAISystem::bAllowControllersAsEQSQuerier' has a wrong offset!");
static_assert(offsetof(UAISystem, bEnableDebuggerPlugin) == 0x0000C1, "Member 'UAISystem::bEnableDebuggerPlugin' has a wrong offset!");
static_assert(offsetof(UAISystem, bForgetStaleActors) == 0x0000C2, "Member 'UAISystem::bForgetStaleActors' has a wrong offset!");
static_assert(offsetof(UAISystem, bAddBlackboardSelfKey) == 0x0000C3, "Member 'UAISystem::bAddBlackboardSelfKey' has a wrong offset!");
static_assert(offsetof(UAISystem, DefaultSightCollisionChannel) == 0x0000C4, "Member 'UAISystem::DefaultSightCollisionChannel' has a wrong offset!");
static_assert(offsetof(UAISystem, BehaviorTreeManager) == 0x0000C8, "Member 'UAISystem::BehaviorTreeManager' has a wrong offset!");
static_assert(offsetof(UAISystem, EnvironmentQueryManager) == 0x0000D0, "Member 'UAISystem::EnvironmentQueryManager' has a wrong offset!");
static_assert(offsetof(UAISystem, PerceptionSystem) == 0x0000D8, "Member 'UAISystem::PerceptionSystem' has a wrong offset!");
static_assert(offsetof(UAISystem, AllProxyObjects) == 0x0000E0, "Member 'UAISystem::AllProxyObjects' has a wrong offset!");
...
static_assert(sizeof(UAITask) == 0x000078, "Wrong size on UAITask");
static_assert(offsetof(UAITask, OwnerController) == 0x000070, "Member 'UAITask::OwnerController' has a wrong offset!");
...
static_assert(offsetof(UAITask_MoveTo, OnRequestFailed) == 0x000078, "Member 'UAITask_MoveTo::OnRequestFailed' has a wrong offset!");
static_assert(offsetof(UAITask_MoveTo, OnMoveFinished) == 0x000088, "Member 'UAITask_MoveTo::OnMoveFinished' has a wrong offset!");
static_assert(offsetof(UAITask_MoveTo, MoveRequest) == 0x000098, "Member 'UAITask_MoveTo::MoveRequest' has a wrong offset!");
...
public:
	...
	TMap<class UBehaviorTree*, struct FBehaviorTreeTemplateInfo> LoadedTemplateMap;                  // 0x0048(0x0050)(Protected, NativeAccessSpecifierProtected)
	uint8                                         Pad_98[0x50];                                      // 0x0098(0x0050)(Fixing Size After Last Property [ Dumper-7 ])
	TArray<class UBehaviorTreeComponent*>         ActiveComponents;                                  // 0x00E8(0x0010)(ExportObject, ZeroConstructor, ContainsInstancedReference, Protected, NativeAccessSpecifierProtected)
...
static_assert(sizeof(UBehaviorTreeManager) == 0x0000F8, "Wrong size on UBehaviorTreeManager");
...
static_assert(sizeof(UBlackboardComponent) == 0x0001C8, "Wrong size on UBlackboardComponent");
static_assert(offsetof(UBlackboardComponent, BrainComp) == 0x0000C0, "Member 'UBlackboardComponent::BrainComp' has a wrong offset!");
static_assert(offsetof(UBlackboardComponent, DefaultBlackboardAsset) == 0x0000C8, "Member 'UBlackboardComponent::DefaultBlackboardAsset' has a wrong offset!");
static_assert(offsetof(UBlackboardComponent, BlackboardAsset) == 0x0000D0, "Member 'UBlackboardComponent::BlackboardAsset' has a wrong offset!");
static_assert(offsetof(UBlackboardComponent, KeyInstances) == 0x0000F8, "Member 'UBlackboardComponent::KeyInstances' has a wrong offset!");
...
static_assert(sizeof(UBTComposite_Selector) == 0x000098, "Wrong size on UBTComposite_Selector");
...
static_assert(sizeof(UBTComposite_SimpleParallel) == 0x0000A0, "Wrong size on UBTComposite_SimpleParallel");
static_assert(offsetof(UBTComposite_SimpleParallel, FinishMode) == 0x000098, "Member 'UBTComposite_SimpleParallel::FinishMode' has a wrong offset!");
...
static_assert(sizeof(UBTDecorator_CheckGameplayTagsOnActor) == 0x0000D8, "Wrong size on UBTDecorator_CheckGameplayTagsOnActor");
...
static_assert(offsetof(UBTDecorator_CheckGameplayTagsOnActor, CachedDescription) == 0x0000C8, "Member 'UBTDecorator_CheckGameplayTagsOnActor::CachedDescription' has a wrong offset!");
...
static_assert(sizeof(UBTService_RunEQS) == 0x000108, "Wrong size on UBTService_RunEQS");
...
static_assert(sizeof(UBTTask_PlayAnimation) == 0x0000B8, "Wrong size on UBTTask_PlayAnimation");
...
static_assert(sizeof(UBTTask_RunEQSQuery) == 0x000170, "Wrong size on UBTTask_RunEQSQuery");
...
static_assert(sizeof(UPathFollowingComponent) == 0x000260, "Wrong size on UPathFollowingComponent");
static_assert(offsetof(UPathFollowingComponent, MovementComp) == 0x0000F8, "Member 'UPathFollowingComponent::MovementComp' has a wrong offset!");
static_assert(offsetof(UPathFollowingComponent, MyNavData) == 0x000108, "Member 'UPathFollowingComponent::MyNavData' has a wrong offset!");
...
public:
	...
	struct FVector                                CrowdAgentMoveDirection;                           // 0x0278(0x000C)(ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
	uint8                                         Pad_284[0x24];                                     // 0x0284(0x0024)(Fixing Struct Size After Last Property [ Dumper-7 ])
...
static_assert(sizeof(UCrowdFollowingComponent) == 0x0002A8, "Wrong size on UCrowdFollowingComponent");
static_assert(offsetof(UCrowdFollowingComponent, CrowdAgentMoveDirection) == 0x000278, "Member 'UCrowdFollowingComponent::CrowdAgentMoveDirection' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryGenerator_OnCircle) == 0x000240, "Wrong size on UEnvQueryGenerator_OnCircle");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, CircleRadius) == 0x000088, "Member 'UEnvQueryGenerator_OnCircle::CircleRadius' has a wrong offset!");
...
static_assert(offsetof(UEnvQueryGenerator_OnCircle, NumberOfPoints) == 0x000108, "Member 'UEnvQueryGenerator_OnCircle::NumberOfPoints' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, PointOnCircleSpacingMethod) == 0x000148, "Member 'UEnvQueryGenerator_OnCircle::PointOnCircleSpacingMethod' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, ArcDirection) == 0x000150, "Member 'UEnvQueryGenerator_OnCircle::ArcDirection' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, ArcAngle) == 0x000170, "Member 'UEnvQueryGenerator_OnCircle::ArcAngle' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, AngleRadians) == 0x0001B0, "Member 'UEnvQueryGenerator_OnCircle::AngleRadians' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, CircleCenter) == 0x0001B8, "Member 'UEnvQueryGenerator_OnCircle::CircleCenter' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, bIgnoreAnyContextActorsWhenGeneratingCircle) == 0x0001C0, "Member 'UEnvQueryGenerator_OnCircle::bIgnoreAnyContextActorsWhenGeneratingCircle' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, CircleCenterZOffset) == 0x0001C8, "Member 'UEnvQueryGenerator_OnCircle::CircleCenterZOffset' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_OnCircle, TraceData) == 0x000208, "Member 'UEnvQueryGenerator_OnCircle::TraceData' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryGenerator_PathingGrid) == 0x000198, "Wrong size on UEnvQueryGenerator_PathingGrid");
static_assert(offsetof(UEnvQueryGenerator_PathingGrid, PathToItem) == 0x000110, "Member 'UEnvQueryGenerator_PathingGrid::PathToItem' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_PathingGrid, NavigationFilter) == 0x000150, "Member 'UEnvQueryGenerator_PathingGrid::NavigationFilter' has a wrong offset!");
static_assert(offsetof(UEnvQueryGenerator_PathingGrid, ScanRangeMultiplier) == 0x000158, "Member 'UEnvQueryGenerator_PathingGrid::ScanRangeMultiplier' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryManager) == 0x000148, "Wrong size on UEnvQueryManager");
...
static_assert(sizeof(UEnvQueryTest_Dot) == 0x000280, "Wrong size on UEnvQueryTest_Dot");
static_assert(offsetof(UEnvQueryTest_Dot, LineA) == 0x000238, "Member 'UEnvQueryTest_Dot::LineA' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Dot, LineB) == 0x000258, "Member 'UEnvQueryTest_Dot::LineB' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Dot, TestMode) == 0x000278, "Member 'UEnvQueryTest_Dot::TestMode' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Dot, bAbsoluteValue) == 0x000279, "Member 'UEnvQueryTest_Dot::bAbsoluteValue' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_Overlap) == 0x000258, "Wrong size on UEnvQueryTest_Overlap");
static_assert(offsetof(UEnvQueryTest_Overlap, OverlapData) == 0x000238, "Member 'UEnvQueryTest_Overlap::OverlapData' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_PathfindingBatch) == 0x000310, "Wrong size on UEnvQueryTest_PathfindingBatch");
static_assert(offsetof(UEnvQueryTest_PathfindingBatch, ScanRangeMultiplier) == 0x0002D0, "Member 'UEnvQueryTest_PathfindingBatch::ScanRangeMultiplier' has a wrong offset!");
...
static_assert(sizeof(UEnvQueryTest_Volume) == 0x000250, "Wrong size on UEnvQueryTest_Volume");
static_assert(offsetof(UEnvQueryTest_Volume, VolumeContext) == 0x000238, "Member 'UEnvQueryTest_Volume::VolumeContext' has a wrong offset!");
static_assert(offsetof(UEnvQueryTest_Volume, VolumeClass) == 0x000240, "Member 'UEnvQueryTest_Volume::VolumeClass' has a wrong offset!");
...
static_assert(sizeof(UEQSRenderingComponent) == 0x000540, "Wrong size on UEQSRenderingComponent");
...
static_assert(offsetof(UPawnAction_Move, GoalActor) == 0x0000A0, "Member 'UPawnAction_Move::GoalActor' has a wrong offset!");
static_assert(offsetof(UPawnAction_Move, GoalLocation) == 0x0000A8, "Member 'UPawnAction_Move::GoalLocation' has a wrong offset!");
static_assert(offsetof(UPawnAction_Move, AcceptableRadius) == 0x0000B4, "Member 'UPawnAction_Move::AcceptableRadius' has a wrong offset!");
...
static_assert(sizeof(UPawnAction_Sequence) == 0x0000C8, "Wrong size on UPawnAction_Sequence");
static_assert(offsetof(UPawnAction_Sequence, ActionSequence) == 0x0000A0, "Member 'UPawnAction_Sequence::ActionSequence' has a wrong offset!");
static_assert(offsetof(UPawnAction_Sequence, ChildFailureHandlingMode) == 0x0000B0, "Member 'UPawnAction_Sequence::ChildFailureHandlingMode' has a wrong offset!");
static_assert(offsetof(UPawnAction_Sequence, RecentActionCopy) == 0x0000B8, "Member 'UPawnAction_Sequence::RecentActionCopy' has a wrong offset!");
...
static_assert(sizeof(UPawnActionsComponent) == 0x0000F8, "Wrong size on UPawnActionsComponent");
static_assert(offsetof(UPawnActionsComponent, ControlledPawn) == 0x0000C0, "Member 'UPawnActionsComponent::ControlledPawn' has a wrong offset!");
static_assert(offsetof(UPawnActionsComponent, ActionStacks) == 0x0000C8, "Member 'UPawnActionsComponent::ActionStacks' has a wrong offset!");
static_assert(offsetof(UPawnActionsComponent, ActionEvents) == 0x0000D8, "Member 'UPawnActionsComponent::ActionEvents' has a wrong offset!");
static_assert(offsetof(UPawnActionsComponent, CurrentAction) == 0x0000E8, "Member 'UPawnActionsComponent::CurrentAction' has a wrong offset!");
