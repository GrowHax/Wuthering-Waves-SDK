...
static_assert(alignof(MediaPlayer_AsyncOpenSourceWithOptions) == 0x000008, "Wrong alignment on MediaPlayer_AsyncOpenSourceWithOptions");
static_assert(sizeof(MediaPlayer_AsyncOpenSourceWithOptions) == 0x000040, "Wrong size on MediaPlayer_AsyncOpenSourceWithOptions");
static_assert(offsetof(MediaPlayer_AsyncOpenSourceWithOptions, MediaSource) == 0x000000, "Member 'MediaPlayer_AsyncOpenSourceWithOptions::MediaSource' has a wrong offset!");
static_assert(offsetof(MediaPlayer_AsyncOpenSourceWithOptions, Options) == 0x000008, "Member 'MediaPlayer_AsyncOpenSourceWithOptions::Options' has a wrong offset!");
static_assert(offsetof(MediaPlayer_AsyncOpenSourceWithOptions, ReturnValue) == 0x000038, "Member 'MediaPlayer_AsyncOpenSourceWithOptions::ReturnValue' has a wrong offset!");
...
static_assert(sizeof(MediaPlayer_OpenSourceLatent) == 0x000068, "Wrong size on MediaPlayer_OpenSourceLatent");
...
static_assert(offsetof(MediaPlayer_OpenSourceLatent, MediaSource) == 0x000028, "Member 'MediaPlayer_OpenSourceLatent::MediaSource' has a wrong offset!");
static_assert(offsetof(MediaPlayer_OpenSourceLatent, Options) == 0x000030, "Member 'MediaPlayer_OpenSourceLatent::Options' has a wrong offset!");
static_assert(offsetof(MediaPlayer_OpenSourceLatent, bSuccess) == 0x000060, "Member 'MediaPlayer_OpenSourceLatent::bSuccess' has a wrong offset!");
...
static_assert(sizeof(MediaPlayer_SetDesiredPlayerName) == 0x00000C, "Wrong size on MediaPlayer_SetDesiredPlayerName");
...
static_assert(sizeof(MediaPlayer_GetDesiredPlayerName) == 0x00000C, "Wrong size on MediaPlayer_GetDesiredPlayerName");
...
static_assert(sizeof(MediaPlayer_GetPlayerName) == 0x00000C, "Wrong size on MediaPlayer_GetPlayerName");
...
// Function MediaAssets.MediaPlayer.IsInAsync
// 0x0001 (0x0001 - 0x0000)
struct MediaPlayer_IsInAsync final
{
public:
	bool                                          ReturnValue;                                       // 0x0000(0x0001)(Parm, OutParm, ZeroConstructor, ReturnParm, IsPlainOldData, NoDestructor, HasGetValueTypeHash, NativeAccessSpecifierPublic)
};
static_assert(alignof(MediaPlayer_IsInAsync) == 0x000001, "Wrong alignment on MediaPlayer_IsInAsync");
static_assert(sizeof(MediaPlayer_IsInAsync) == 0x000001, "Wrong size on MediaPlayer_IsInAsync");
static_assert(offsetof(MediaPlayer_IsInAsync, ReturnValue) == 0x000000, "Member 'MediaPlayer_IsInAsync::ReturnValue' has a wrong offset!");
