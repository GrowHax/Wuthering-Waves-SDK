...
public:
	...
	int32                                         层数;                                              // 0x0560(0x0004)(Edit, BlueprintVisible, ZeroConstructor, DisableEditOnInstance, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
static_assert(offsetof(UGA_Common_AirShot_C, 层数) == 0x000560, "Member 'UGA_Common_AirShot_C::层数' has a wrong offset!");
