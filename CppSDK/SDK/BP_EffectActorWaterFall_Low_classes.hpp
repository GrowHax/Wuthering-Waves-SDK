...
static_assert(sizeof(ABP_EffectActorWaterFall_Low_C) == 0x000348, "Wrong size on ABP_EffectActorWaterFall_Low_C");
static_assert(offsetof(ABP_EffectActorWaterFall_Low_C, UberGraphFrame) == 0x0002B8, "Member 'ABP_EffectActorWaterFall_Low_C::UberGraphFrame' has a wrong offset!");
static_assert(offsetof(ABP_EffectActorWaterFall_Low_C, DefaultSceneRoot) == 0x0002C0, "Member 'ABP_EffectActorWaterFall_Low_C::DefaultSceneRoot' has a wrong offset!");
static_assert(offsetof(ABP_EffectActorWaterFall_Low_C, EffectData) == 0x0002C8, "Member 'ABP_EffectActorWaterFall_Low_C::EffectData' has a wrong offset!");
static_assert(offsetof(ABP_EffectActorWaterFall_Low_C, DebugPrintOnConstruction) == 0x0002E8, "Member 'ABP_EffectActorWaterFall_Low_C::DebugPrintOnConstruction' has a wrong offset!");
static_assert(offsetof(ABP_EffectActorWaterFall_Low_C, EditorTickWithoutSelected) == 0x0002E9, "Member 'ABP_EffectActorWaterFall_Low_C::EditorTickWithoutSelected' has a wrong offset!");
static_assert(offsetof(ABP_EffectActorWaterFall_Low_C, EffectComponent) == 0x0002EC, "Member 'ABP_EffectActorWaterFall_Low_C::EffectComponent' has a wrong offset!");
static_assert(offsetof(ABP_EffectActorWaterFall_Low_C, PlayType) == 0x0002F0, "Member 'ABP_EffectActorWaterFall_Low_C::PlayType' has a wrong offset!");
static_assert(offsetof(ABP_EffectActorWaterFall_Low_C, EffectType) == 0x0002F1, "Member 'ABP_EffectActorWaterFall_Low_C::EffectType' has a wrong offset!");
static_assert(offsetof(ABP_EffectActorWaterFall_Low_C, Float_Parameters) == 0x0002F8, "Member 'ABP_EffectActorWaterFall_Low_C::Float_Parameters' has a wrong offset!");
