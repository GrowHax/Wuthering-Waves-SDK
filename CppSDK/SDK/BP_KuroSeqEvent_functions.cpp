...
// Parameters:
// const struct FSSubtitleSettings&        inSubtitle                                             (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// (Public, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FSSubtitleSettings&        inSubtitleSettings                                     (BlueprintVisible, BlueprintReadOnly, Parm, ZeroConstructor, IsPlainOldData, NoDestructor, HasGetValueTypeHash)
...
// (Public, HasDefaults, BlueprintCallable, BlueprintEvent)
// Parameters:
// const struct FSSeqCharacterBlendGroup&  inSettings                                             (BlueprintVisible, BlueprintReadOnly, Parm, HasGetValueTypeHash)
