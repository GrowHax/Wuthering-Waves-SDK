...
void UMediaPlayer::AsyncClose()
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MediaPlayer", "AsyncClose");
...
bool UMediaPlayer::AsyncOpenSourceWithOptions(class UMediaSource* MediaSource, const struct FMediaPlayerOptions& Options)
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MediaPlayer", "AsyncOpenSourceWithOptions");

	Params::MediaPlayer_AsyncOpenSourceWithOptions Parms{};
...
bool UMediaPlayer::IsInAsync() const
{
	static class UFunction* Func = nullptr;

	if (Func == nullptr)
		Func = Class->GetFunction("MediaPlayer", "IsInAsync");

	Params::MediaPlayer_IsInAsync Parms{};
